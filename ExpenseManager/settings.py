...
SECRET_KEY = 'django-insecure-tn08+g&@e#!t-zx^652s(yy4dsr(2)ku_yg1kp$hs(p-l13umx'
...
# Added budget limit (for budget alert)
BUDGET_LIMIT = 1000  # Set your monthly budget limit here (in dollars)
